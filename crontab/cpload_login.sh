...
loadfile=/usr/local/nginx/logs/${LOG_DATE}_login.txt
xj_file=/usr/local/nginx/logs/${LOG_DATE}_xj_login.txt


if [ -e $LOGFILE ];then
  echo "${LOGFILE} exist,now load file"
  awk '{print $4,$7}' $LOGFILE  |grep -v 'images' | grep login | awk -F '[/|=|&]' '{print $3,$4,$5,$6,$7,$8,$9,$10,$11}' |grep -v gate_xj|grep -v gate_igw|grep -v gate_tz|awk '{print $1 "|"$2"|"$8}' >>$loadfile
  awk '{print $4,$7}' $LOGFILE  |grep -v 'images' | grep login | awk -F '[/|=|&]' '{print $3,$4,$5,$6,$7,$8,$9,$10,$11}' |awk '{if ( $2=="gate_xj" ) print $1"|"$2"|"$4}' >>$loadfile
  awk '{print $4,$7}' $LOGFILE  |grep -v 'images' | grep login | awk -F '[/|=|&]' '{print $3,$4,$5,$6,$7,$8,$9,$10,$11}' |awk '{if ( $2=="gate_igw" ) print $1"|"$2"|"$4}' >>$loadfile
  awk '{print $4,$7}' $LOGFILE  |grep -v 'images' | grep login | awk -F '[/|=|&]' '{print $3,$4,$5,$6,$7,$8,$9,$10,$11}' |awk '{if ( $2=="gate_tz" ) print $1"|"$2"|"$4}' >>$loadfile
  awk '{print $4,$7}' $LOGFILE  |grep -v 'images' | grep login | awk -F '[/|=|&]' '{print $3,$4,$5,$6,$7,$8,$9,$10,$11}' |awk '{if ( $2=="gate_xj" ) print $1"|"$2"|"$4}' >>$xj_file
  sed -i -e "s/2013:/${DATE}\| /g" $loadfile
  sed -i -e "s/2013:/${DATE}\| /g" $xj_file
