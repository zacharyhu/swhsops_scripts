...
SELECT DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 DAY),'%y%m%d') as l_date,t1.game_id,t2.l_game_name,t1.total_num,t1.user_num,t1.total_num/t1.user_num,t1.chg_points,'0' FROM gp_chg_daily t1, gp_gameid_cfg t2
