...
echo "LOAD DATA LOCAL INFILE '${file3}' replace into table gp_user_info FIELDS TERMINATED BY '\|'" |mysql -h10.48.179.112 -udc -pdc datacenter
echo "LOAD DATA LOCAL INFILE '${file3}' replace into table gp_data_center.gp_user_info FIELDS TERMINATED BY '\|'" |mysql -h10.48.179.112 -udc -pdc
